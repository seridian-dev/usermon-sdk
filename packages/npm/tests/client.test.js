...
import { UsermonClient } from '../dist/esm/client.js';
...
test('JavaScript / TypeScript UsermonClient test suite', async (t) => {
  ...
  await t.test('buffered capture and explicit flush', async () => {
    lastBatch = {};
